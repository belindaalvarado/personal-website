...
export default function Home() {
  ...
  return <div className="min-h-screen bg-customBackground flex flex-col w-full font-playfair">
      ...
      <div className="flex max-md:flex-col w-full justify-between">
        <Image src={belindaPic1} alt="hero" className="w-full md:hidden" width={1920} height={1080} />
          ...
          <span className="font-nunito font-bold text-customBerry text-lg">Graduate Student</span>
            <h2 className="font-playfair leading-10 mt-4 font-bold flex flex-col text-black text-3xl">
            Hello, my name is <span>
            Belinda Alvarado
            </span>
            </h2>
            <p className="font-nunito text-customLightGray leading-10 font-normal text-lg mt-4 w-10/12">
            ...
            <div className="self-start mt-5 gap-3 flex">
          <a href="#Projects" className="bg-customBerry text-center p-2 hover:bg-white hover:text-customBerry transition-colors hover:outline outline-customBerry rounded w-40 text-white">
            Projects</a>
            <a href="https://www.linkedin.com/in/belindaalvarado653/" className="bg-white outline-customBerry outline p-2 rounded w-40 text-center hover:bg-customBerry transition-colors hover:text-white text-customBerry">Linked In</a></div>
          </div>
    ...
    {/* main section end */}
    {/* about section start */}
    <section id="About" className="min-h-screen flex max-md:flex-col gap-10 justify-center items-center w-full">
      <Image src={belindaPic2} alt="BelindaPic2" className="w-2/5 max-md:w-full"></Image>
      <div className=" w-2/5 max-md:w-full max-md:p-5 flex flex-col gap-5">
        <h3 className="text-4xl font-playfair font-bold text-black">About Me</h3>
        <span className="font-nunito font-normal text-xl leading-10 text-customLightGray">
        ...
        <button className="bg-customBerry text-center p-2 hover:bg-white hover:text-customBerry transition-colors hover:outline outline-customBerry rounded w-40 text-white">
                  Resume</button>
      </div>
    </section>
    {/* about section end */}
    ...
    <section id="Projects" className="min-h-screen gap-10 mt-20 items-center w-full flex flex-col justify-center">
          <h4 className="flex flex-col items-center justify-end text-black font-playfair mb-10 font-bold text-5xl">Projects
      ...
      <div className="w-full flex justify-center items-center max-md:flex-col">
        ...
        <span className="font-playfair text-3xl font-bold text-black">Trimming Trends</span>
          <p className="text-customLightGray font-nunito font-normal leading-10 text-lg">
        ...
        <a className="w-40 rounded-full p-2 self-start mt-5 text-center outline outline-black bg-white hover:bg-white/50 transition-colors">View Project</a>
        </div>
        <div className="w-1/3 max-md:w-full bg-transparent">
        <Image src={projectPic1} alt="TrimmingTrends" className="w-fit max-md:w-full"></Image></div>
      </div>
      {/* second project */}
      <div className="w-full flex justify-center items-center max-md:flex-col">
        <div className="w-1/3 max-md:w-full bg-transparent">
        <Image src={projectPic2} alt="FronteraHacks" className="w-fit max-md:w-full"></Image></div>
        <div className="bg-white self-center py-20 px-10 gap-5 w-1/3 flex flex-col justify-center items-center max-md:w-full">
        <span className="font-playfair text-3xl font-bold text-black">Frontera Hacks</span>
          <p className="text-customLightGray font-nunito font-normal leading-10 text-lg">
      ...
      <div className="w-full flex justify-center items-center max-md:flex-col">
        <div className="bg-white self-center py-20 px-10 gap-5 w-1/3 flex flex-col justify-center items-center max-md:w-full">
        <span className="font-playfair text-3xl font-bold text-black">Intro to CS Projects</span>
          <p className="text-customLightGray font-nunito font-normal leading-10 text-lg">
        ...
        <div className="w-1/3 max-md:w-full bg-transparent">
        <Image src={projectPic3} alt="TrimmingTrends" className="w-fit max-md:w-full"></Image></div>
      </div>
    </section>
    ...
    <section id="Contact" className="min-h-screen flex justify-center items-center w-full">
      <div className="w-full flex flex-col gap-5 items-center">
        <h5 className="flex flex-col items-center justify-end text-black font-playfair mb-10 font-bold text-5xl">Contact Me
          <span className="bg-customBerry w-2/3 p-0.5"></span>
        </h5>
      ...
      <button type="submit" className=" bg-customBerry w-40 p-2 text-white font-roboto text-lg hover:bg-white hover:outline outline-customBerry transition-colors hover:text-customBerry">Send Message</button>
      </div>
        </form>
      </div>
    </section>
      <div className="flex flex-col w-full h-full items-center">
        <div className="w-full flex justify-center gap-3">
          <a href="">
            <Image className="max-md:w-4/5" src={instagramLogo} alt="instagram"></Image>
            </a>
          <a href="https://www.linkedin.com/in/belindaalvarado653/">
            <Image className="max-md:w-4/5" src={linkedinLogo} alt="linkedin"></Image>
          </a>
          <a href="mailto:alvaradobelinda653@gmail.com">
            <Image className="max-md:w-4/5" src={envelopeLogo} alt="email"></Image>
          </a>
        </div>
        <span className="font-nunito text-customLightGray text-base">
